...
const ZERO_HARDWARE_PREFIXES = ['F3', 'F4', 'F5', 'F6', 'TRP', 'BRP', 'TKPW', 'TKC', 'OCM', 'WF', 'TF', 'BEP', 'REP', 'TREP', 'VEP', 'EPB', 'TK8', 'TK', 'TSK', 'SCM', 'SMC']
...
export function getSection(sku) {
  ...
  if (/^(PLYS|EPT|AD21|REP|TREP|VEP)/.test(u))           return 'End Panel'
