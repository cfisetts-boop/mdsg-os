...
const ZERO_HARDWARE_PREFIXES = ['F3', 'F4', 'F5', 'F6', 'TRP', 'BRP', 'TKPW', 'TKC', 'OCM', 'WF', 'TF', 'BEP', 'REP', 'TREP', 'VEP', 'TEP', 'EPB', 'TK8', 'TK', 'TSK', 'SCM', 'SMC']
...
export function isAppliance(sku) {
  ...
  // NOTE: DW followed by 4 digits (DW2430R) is a Diagonal Wall corner CABINET,
  // not a dishwasher — dishwashers appear as DISH*/DW/DW24 (0-2 digits).
